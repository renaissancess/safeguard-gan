...
parser.add_argument('--batchSize', type=int, default=48,help='批次大小')
parser.add_argument('--imageWidth', type=int, default=512,help='图像宽度')
parser.add_argument('--imageHeight', type=int, default=1024,help='图像高度')
parser.add_argument('--nz', type=int, default=500, help='输入向量大小')
parser.add_argument('--ngf', type=int, default=64, help='生成器中间通道数')
parser.add_argument('--ndf', type=int, default=32, help='鉴别器中间通道数')
...
transforms = torchvision.transforms.Compose([
    torchvision.transforms.Resize((opt.imageWidth,opt.imageHeight)),# 裁剪成96*96
